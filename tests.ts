...
// const premierChinstrap = penguins.find((penguins) => penguins.species === "Chinstrap");
...
// const indexChinstrap = penguins.findIndex((penguins) => penguins.species === "Chinstrap");
...
// const tousOntMasse = penguins.every(p => p.body_mass_g > 0);
...
// const pingousinsMales = penguins.filter((penguins) => penguins.sex === "MALE");
// console.log("• filter() - Nombre de mâles:", pingousinsMales.length);

// const pingouinsLourds = penguins.filter((penguins) => penguins.body_mass_g > 5000);
